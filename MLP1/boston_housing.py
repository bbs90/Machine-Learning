...
def explore_city_data(city_data):
    ...
    num_of_houses, num_of_features = np.shape(housing_features)
    
   
    # Size of data (number of houses)?
    print "Size of data (number of houses):", num_of_houses
    ...
    print "Standard deviation of house price:", np.std(housing_prices)
...
def fit_predict_model(city_data):
    ...
    score = make_scorer(performance_metric, greater_is_better=False)
    ...
    best_reg = reg.best_params_
    print "Best parameter:",best_reg
